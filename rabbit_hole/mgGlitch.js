                                ...
                                if(this.settings.destroy === true) {
                	                ...
                	                // clone this.element insert before addclass back = static element
                                        ...
                                        if (this.settings.blend === true) { 
                                                ...
                                                var cloneEl = $(el).clone();
                                                cloneEl.insertAfter(el).prop('id', cloneEl.insertAfter(el).prop('id') + '-3')
                                        ...
                                        if (this.settings.glitch === true) {
                                               ...
                                               var cloneEl = $(el).clone();
                                               cloneEl.insertAfter(el).prop('id', cloneEl.insertAfter(el).prop('id') + '-2')
                                               cloneEl.insertAfter(el).addClass('front-2').css({'id': this.id + '-2', 'z-index' : zIndexStart + 2});

                                               // add class middle to elem
                                               $('.back').next().prop('id', $('.back').next().prop('id') + '-1')
